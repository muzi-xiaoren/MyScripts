...
Automatically does the daily check-in (签到, for magic/bonus points) whenever you open any [carpt.net](https://carpt.net/) page:
...
Install [Tampermonkey](https://www.tampermonkey.net/) first, then [click here to install the script](https://raw.githubusercontent.com/muzi-xiaoren/MyScripts/main/pt-checkin-carpt/pt-checkin-carpt.user.js).
