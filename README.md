...
| [pt-checkin-mua](./pt-checkin-mua) | mua.xloli.cc：打开页面时自动检测并完成每日签到，未签到则签到后回到 `special.php` 并刷新，已签到则不动 | [安装](https://raw.githubusercontent.com/muzi-xiaoren/MyScripts/main/pt-checkin-mua/pt-checkin-mua.user.js) |
