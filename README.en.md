...
| [pt-checkin-mua](./pt-checkin-mua) | mua.xloli.cc: on page open, auto-detect and do the daily check-in — if pending, check in then return to `special.php` and reload; do nothing if already done | [Install](https://raw.githubusercontent.com/muzi-xiaoren/MyScripts/main/pt-checkin-mua/pt-checkin-mua.user.js) |
