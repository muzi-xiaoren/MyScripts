...
| [pt-checkin-vclib](./pt-checkin-vclib) | 1.0.1 | VC-Lib: if today's check-in is pending, show the site's own captcha (2x scaled) in a centered panel on the page you're on — type all 6 characters and it checks in and reloads (you read the captcha; the script never solves it); nothing shows if already done | [Install](https://raw.githubusercontent.com/muzi-xiaoren/MyScripts/main/pt-checkin-vclib/pt-checkin-vclib.user.js) |
