...
| [pt-tangpt-helper](./pt-tangpt-helper) | 1.0.1 | tangpt multi-feature helper, one toggle per feature: (1) bulk inbox cleanup (delete every read message plus unread ones whose subject starts with 「任务」, keep the rest) (2) cumulative lottery log (side panel, persisted per day, bonus points tracked as totals only) | [Install](https://raw.githubusercontent.com/muzi-xiaoren/MyScripts/main/pt-tangpt-helper/pt-tangpt-helper.user.js) |
