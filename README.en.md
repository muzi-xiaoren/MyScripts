...
|---|---|---|---|
| [github-pr-tab](./github-pr-tab) | 3.9.0 | GitHub PR/Issue pages: show only `#number` in the browser tab, and color the favicon by status (gray for stacked/non-trunk base, red for conflict, etc.) | [Install](https://raw.githubusercontent.com/muzi-xiaoren/MyScripts/main/github-pr-tab/github-pr-tab.user.js) |
